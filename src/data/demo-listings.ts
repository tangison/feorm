// ─── Static Demo Data (Tree-shakeable) ──────────────────────────
// All 14 Namibian regions represented with authentic cultural context.
// Prices in Namibian cents (N$ 850 = 85000 cents).
// This file is code-split from the hook so it's not shipped to the
// client when the REST API is available.
...
export const ALL_DEMO = [...DEMO_STAYS, ...DEMO_EQUIPMENT];
