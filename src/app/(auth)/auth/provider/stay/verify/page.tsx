...
export default function ProviderStayVerifyPage() {
  ...
  return (
    <div className="relative flex-grow flex items-center justify-center p-6 md:p-12 min-h-screen">
      ...
      <div className="max-w-md w-full relative z-10">
        {/* Back button */}
        <button
          onClick={() => router.push("/auth/provider/stay/property")}
        ...
        <div className="space-y-4 mb-8">
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3">
                <CheckCircle size={16} className="text-verified shrink-0 mt-0.5" />
                <p className="text-sm text-white/80">Proof of property ownership or lease</p>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle size={16} className="text-verified shrink-0 mt-0.5" />
